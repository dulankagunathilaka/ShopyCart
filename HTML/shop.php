        ...
        <nav class="navbar navbar-light bg-white navbar-expand-xl">
            ...
            <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    ...
                    <a href="../HTML/product-details.php" class="nav-item nav-link active">About ShopyCart</a>
                    ...
                    <a href="#" class="my-auto">
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                <a href="" class="btn border-secondary py-2 px-2 rounded-pill text-primary">SignIn/SignUp</a>
...
<!-- Navbar End -->
        ...
        <div class="container-fluid fruite py-5">
            <div class="container py-5">
                <h1 class="mb-4">Shopy Cart Super Market</h1>
                <div class="row g-4">
                    <div class="col-lg-12">
                        <div class="row g-4">
                            <div class="col-xl-3">
